...
const BLOG = {
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || 'hello,good luck to you',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'yeyan', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'OIer一个', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://blog.yeyanpro.cn', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'yeyan,yeyanpro,博客,blog', // 网站关键词 英文逗号隔开
  ...
  DESCRIPTION:
        process.env.NEXT_PUBLIC_DESCRIPTION || 'yeyanpro.cn', // 站点描述，被notion中的页面描述覆盖
